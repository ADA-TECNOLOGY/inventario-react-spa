import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, Card, CardBody, Checkbox, Flex, FormControl, FormErrorMessage, FormLabel, Input, RadioGroup, Select, SimpleGrid, Text } from "@chakra-ui/react";
import { Link, useNavigate } from "react-router-dom";
import MaskedInput from "react-text-mask";
import { cepMask, phoneNumberMask } from "../../../util/masksInput";
...
export default function CreateEmployee() {
    ...
    const handleCreateEmployee: SubmitHandler<EmployeeFormData> =
